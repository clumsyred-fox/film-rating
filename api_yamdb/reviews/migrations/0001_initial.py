# Generated by Django 3.2 on 2023-05-05 12:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'User with that username already exists.'}, help_text='Required. 150 characters or fewer.Letters, digits and @/./+/-/_ only.', max_length=150, unique=True, validators=[django.core.validators.RegexValidator('^[\\\\w.@+-]+\\\\zRequired. 150 characters or fewer.Letters, digits and @/./+/-/_ only.')], verbose_name='Никнейм')),
                ('bio', models.TextField(max_length=250, verbose_name='Биография')),
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('moderator', 'Moderator'), ('user', 'User')], default='USER', max_length=20, verbose_name='Статус пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, 'Оцените от 1 до 10'), django.core.validators.MaxValueValidator(10, 'Оцените от 1 до 10')], verbose_name='Рейтинг')),
